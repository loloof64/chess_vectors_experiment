  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new CustomPaint(
        painter: new VectorImagePainter(<VectorImagePathGroup>[
          VectorImagePathGroup(path:"M 22,10 C 32.5,11 38.5,18 38,39"
              " L 15,39 C 15,30 25,32.5 23,18"),
          VectorImagePathGroup(path:"M 24,18 C 24.38,20.91 18.45,25.37"
          ...
          VectorImagePathGroup(path: "M 9.5 25.5 A 0.5 0.5 0 1 1"
              " 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z", fillColor: Colors.black),
          VectorImagePathGroup(path: "M 15 15.5 A 0.5 1.5 0 1 1"
              "  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z", fillColor: Colors.black)
        ]),
      ),
    );
  }
