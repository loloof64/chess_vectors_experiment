  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new CustomPaint(
        painter: new VectorPainter(
            parsePathList([
              "M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18",
              "M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C "
...
class VectorPainter extends CustomPainter {
  ...
  List<List<PathElement>> vectorDefinition;

  VectorPainter(this.vectorDefinition);

  @override
  void paint(Canvas canvas, Size size) {
    Path path = new Path();

    vectorDefinition.forEach((List<PathElement> currentPath){
      currentPath.forEach((PathElement currentElement) {
        currentElement.addToPath(path);
      });
    });

    var pathPaint = new Paint()
